  ...
  return (
    <button
      className={cn(
        ...
        variant === 'default' &&
          'bg-primary hover:bg-primary/80 active:bg-primary border-primary gap-2 rounded-lg border-2 px-4 py-2 text-white',
        variant === 'primary' &&
          'border-primary text-primary hover:bg-primary/10 active:bg-primary/30 gap-2 rounded-lg border-2 bg-transparent px-4 py-2',
        variant === 'glass' &&
